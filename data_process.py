...
#df = pd.read_csv(r"C:\Users\name\Desktop\cleaned_data.csv",nrows=2000)
#df = pd.read_csv(r"export_dataframe.csv")
#pd.DataFrame.to_csv(df,r"C:\Users\name\Desktop\export_dataframe.csv",index=False)
#pd.DataFrame.to_csv(df,"export_dataframe.csv",index=False)

#print(df.iloc[:, -1])
#pd.DataFrame.to_csv(df.iloc[:,:-2],r"C:\Users\name\Desktop\export_dataframe.csv",index=False)
...
def loss(data,pred):
    def vae_loss(y_true, y_pred):
        ...
        y_true = tf.convert_to_tensor(y_true, dtype_hint=tf.float64)
        y_pred = tf.convert_to_tensor(y_pred, dtype_hint=tf.float64)
